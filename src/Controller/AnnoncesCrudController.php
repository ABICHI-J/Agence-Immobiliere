...
#[Route('/annonces/crud')]
class AnnoncesCrudController extends AbstractController
{
    #[Route('/', name: 'app_annonces_crud_index', methods: ['GET'])]
    public function index(AnnoncesRepository $annoncesRepository): Response
    {
        return $this->render('annonces_crud/index.html.twig', [
    ...
    public function new(Request $request, AnnoncesRepository $annoncesRepository,UploadFile $uploadFile): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_annonces_crud_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('annonces_crud/new.html.twig', [
            'annonce' => $annonce,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_annonces_crud_show', methods: ['GET'])]
    public function show(Annonces $annonce): Response
    {
        return $this->render('annonces_crud/show.html.twig', [
            'annonce' => $annonce,
        ]);
    }
    ...
    public function edit(Request $request, Annonces $annonce, AnnoncesRepository $annoncesRepository,UploadFile $uploadFile): Response
    {
        ...
        return $this->renderForm('annonces_crud/edit.html.twig', [
            'annonce' => $annonce,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_annonces_crud_delete', methods: ['POST'])]
